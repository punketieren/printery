...
//#endregion
//#region node_modules/@milkdown/exception/lib/index.js
...
//#endregion
//#region node_modules/@milkdown/ctx/lib/index.js
var Container = class {
	constructor() {
...
function tokenizeListContinuation(effects, ok, nok) {
	...
	function notInCurrentItem(code) {
		...
		self.interrupt = void 0;
		ok$1(self.parser.constructs.disable.null, "expected `disable.null` to be populated");
		return factorySpace(effects, effects.attempt(list$2, ok, nok), types.linePrefix, self.parser.constructs.disable.null.includes("codeIndented") ? void 0 : constants.tabSize)(code);
	}
}
/**
* @this {TokenizeContext}
...
var contentInitial = { [codes.leftSquareBracket]: definition$1 };
...
var DOMSerializer = class DOMSerializer {
	...
	*/
	serializeFragment(fragment, options = {}, target) {
		if (!target) target = doc$2(options).createDocumentFragment();
...
function renderSpec(doc, structure, xmlNS, blockArraysIn) {
	if (structure.nodeType == 3) return { dom: structure };
	if (structure.dom && structure.dom.nodeType == 3) return structure;
...
//#endregion
//#region node_modules/@milkdown/prose/lib/index.js
var nav$1 = typeof navigator != "undefined" ? navigator : null;
var doc$1 = typeof document != "undefined" ? document : null;
var agent$1 = nav$1 && nav$1.userAgent || "";
var ie_edge$1 = /Edge\/(\d+)/.exec(agent$1);
var ie_upto10$1 = /MSIE \d/.exec(agent$1);
var ie_11up$1 = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(agent$1);
var ie$2 = !!(ie_upto10$1 || ie_11up$1 || ie_edge$1);
ie_upto10$1 ? document.documentMode : ie_11up$1 ? +ie_11up$1[1] : ie_edge$1 && +ie_edge$1[1];
!ie$2 && /gecko\/(\d+)/i.test(agent$1) && +(/Firefox\/(\d+)/.exec(agent$1) || [0, 0])[1];
var _chrome$1 = !ie$2 && /Chrome\/(\d+)/.exec(agent$1);
var chrome$1 = !!_chrome$1;
_chrome$1 && +_chrome$1[1];
!ie$2 && nav$1 && /Apple Computer/.test(nav$1.vendor) && (/Mobile\/\w+/.test(agent$1) || nav$1 && nav$1.maxTouchPoints > 2) || nav$1 && /Mac/.test(nav$1.platform);
var android$1 = /Android \d/.test(agent$1);
doc$1 && "webkitFontSmoothing" in doc$1.documentElement.style && +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1];
	...
	const plugin = new Plugin({
		...
		props: {
			...
			handleDOMEvents: {
				...
				keydown: (view, event) => {
					if (!(android$1 && chrome$1 && event.key === "Enter")) return false;
					if (view.composing) return false;
...
function markRule(regexp, markType, options = {}) {
	return new InputRule(regexp, (state, match, start, end) => {
		...
		if (group) {
			...
			(_d = options.beforeDispatch) == null || _d.call(options, {
				match,
				start,
				end,
				tr
...
var findNodeInSelection = (state, node) => {
...
function keyName(event) {
	var name = !(mac$2 && event.metaKey && event.shiftKey && !event.ctrlKey && !event.altKey || ie$1 && event.shiftKey && event.key && event.key.length == 1 || event.key == "Unidentified") && event.key || (event.shiftKey ? shift : base)[event.keyCode] || event.key || "Unidentified";
...
var windows$1 = typeof navigator != "undefined" && /Win/.test(navigator.platform);
...
function keydownHandler(bindings) {
	...
	return function(view, event) {
		...
		if (name.length == 1 && name != " ") {
			...
			if ((event.altKey || event.metaKey || event.ctrlKey) && !(windows$1 && event.ctrlKey && event.altKey) && (baseName = base[event.keyCode]) && baseName != name) {
...
//#endregion
//#region node_modules/@milkdown/transformer/lib/index.js
...
//#endregion
//#region node_modules/@milkdown/core/lib/index.js
...
//#endregion
export { rootDOMCtx as $, getDoc as A, findWrapping as At, nodesCtx as B, expectDomTypeError as Bt, editorStateCtx as C, TextSelection as Ct, editorViewCtx as D, ReplaceStep as Dt, editorView as E, ReplaceAroundStep as Et, keymapCtx as F, Slice as Ft, pasteRulesCtx as G, parserCtx as H, missingNodeInSchema as Ht, keymapTimerCtx as I, visit as It, remarkCtx as J, pasteRulesTimerCtx as K, markViewCtx as L, SKIP as Lt, initTimerCtx as M, Fragment as Mt, inputRulesCtx as N, Node as Nt, editorViewOptionsCtx as O, canJoin as Ot, keymap as P, NodeRange as Pt, rootCtx as Q, marksCtx as R, visitParents as Rt, editorState as S, Selection as St, editorStateTimerCtx as T, Mapping as Tt, parserTimerCtx as U, parser as V, missingMarkInSchema as Vt, pasteRule as W, remarkStringifyOptionsCtx as X, remarkPluginsCtx as Y, rootAttrsCtx as Z, commandsTimerCtx as _, toggleMark as _t, EditorStateReady as a, serializerTimerCtx as at, defaultValueCtx as b, Plugin as bt, InitReady as c, keydownHandler as ct, ParserReady as d, markRule as dt, schema as et, PasteRulesReady as f, InputRule as ft, commandsCtx as g, setBlockType as gt, commands as h, joinBackward as ht, Editor as i, serializerCtx as it, init as j, liftTarget as jt, editorViewTimerCtx as k, canSplit as kt, KeymapManager as l, findNodeInSelection as lt, SerializerReady as m, wrappingInputRule as mt, CommandsReady as n, schemaTimerCtx as nt, EditorStatus as o, Decoration as ot, SchemaReady as p, textblockTypeInputRule as pt, prosePluginsCtx as q, ConfigReady as r, serializer as rt, EditorViewReady as s, DecorationSet as st, CommandManager as t, schemaCtx as tt, KeymapReady as u, findSelectedNodeOfType as ut, config as v, wrapIn as vt, editorStateOptionsCtx as w, AddMarkStep as wt, editorCtx as x, PluginKey as xt, createCmdKey as y, NodeSelection as yt, nodeViewCtx as z, createSlice as zt };

//# sourceMappingURL=lib-BI2HRKGl.js.map