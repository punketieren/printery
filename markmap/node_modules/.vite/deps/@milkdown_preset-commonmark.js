import { At as findWrapping, Bt as expectDomTypeError, Ct as TextSelection, D as editorViewCtx, Dt as ReplaceStep, Et as ReplaceAroundStep, Ft as Slice, It as visit, Lt as SKIP, Mt as Fragment, Nt as Node, Ot as canJoin, Pt as NodeRange, Rt as visitParents, St as Selection, X as remarkStringifyOptionsCtx, _t as toggleMark, bt as Plugin, dt as markRule, ft as InputRule, g as commandsCtx, gt as setBlockType, ht as joinBackward, jt as liftTarget, kt as canSplit, lt as findNodeInSelection, mt as wrappingInputRule, ot as Decoration, pt as textblockTypeInputRule, st as DecorationSet, ut as findSelectedNodeOfType, vt as wrapIn, wt as AddMarkStep, xt as PluginKey } from "./lib-BI2HRKGl.js";
import { a as $markSchema, c as $nodeSchema, d as $useKeymap, i as $markAttr, l as $prose, n as $ctx, o as $node, r as $inputRule, s as $nodeAttr, t as $command, u as $remark } from "./lib-CDsgyYZi.js";
...
//#endregion
//#region node_modules/mdast-util-definitions/lib/index.js
/**
...
function definitions(tree) {
	...
	visit(tree, "definition", function(definition) {
		...
		if (id && !cache.get(id)) cache.set(id, definition);
	});
	return definition;
	/** @type {GetDefinition} */
...
//#endregion
//#region node_modules/remark-inline-links/lib/index.js
/**
		...
		visit(tree, function(node, index, parent) {
			...
			if (node.type === "imageReference" || node.type === "linkReference") {
				...
				if (def && parent && typeof index === "number") {
					parent.children[index] = node.type === "imageReference" ? {
						type: "image",
						url: def.url,
						title: def.title,
						alt: node.alt
...
//#endregion
//#region node_modules/@milkdown/preset-commonmark/lib/index.js
